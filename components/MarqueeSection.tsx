        ...
        <div className="relative w-full overflow-hidden">
          <div className="flex whitespace-nowrap animate-marquee">
            {[...items, ...items, ...items].map((item, i) => (
              <span
                key={i}
                className="mx-8 text-2xl md:text-3xl font-semibold text-[#BF9B30]"
              >
                {item} —
              </span>
            ))}
            ...
            <div className="space-y-10">
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm leading-relaxed">
                    Every journey is delivered with professionalism, elegance and attention to detail.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm leading-relaxed">
                    Reliable chauffeur support available day and night for complete peace of mind.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-10">
              <div className="flex gap-4 items-start flex-row-reverse text-right">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm leading-relaxed">
                    Luxury chauffeur travel with clear pricing and no hidden charges.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 items-start flex-row-reverse text-right">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm leading-relaxed">
                    Seamless pickup and drop-off tailored around your schedule.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="relative max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start mb-16">
            ...
            <p className="text-gray-300 leading-relaxed text-sm md:text-base">
              Our chauffeur service is built for business travel, airport transfers,
              corporate events and private journeys. Each vehicle is maintained to
              the highest standards to ensure comfort, safety and discretion.
            </p>
          </div>
